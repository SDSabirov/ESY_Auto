<template>
    <div>
        <nav class="sticky bg-transparent border-gray-200 dark:bg-gray-900">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between md:mx-40 py-4 sm:px-1">
                ...
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-light-bg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-light-bg dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
